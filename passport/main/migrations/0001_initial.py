    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=main.models.item_img_path)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(0, 'Quantity should be >= 0')])),
                ('tray', models.IntegerField(default=1, help_text='Select tray 0 for optional items.')),
                ('comment', models.TextField(blank=True, null=True)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='main.item')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='main.set')),
            ],
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AddField(
            model_name='order',
            name='sets',
            field=models.ManyToManyField(through='main.OrderSet', to='main.set'),
        ),
        migrations.AddField(
            model_name='item',
            name='series',
